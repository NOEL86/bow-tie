  ...
  render() {
    return (
      <div>
        ...
        <div className="card">
          ...
          <div className="row left">
            <div className="col s12 m6 lg4">
              <p>
                ...
                everything goes smoothly while you enjoy your day you’ve worked
                so hard to plan; enter Bow & Tie. Our Day Of package includes:
              </p>
            </div>
          </div>
          ...
          <div className="row">
            <div className="col s12 m6 lg4">
              <ul id="package1">
                <li>
                  Unlimited phone calls and emails throughout your engagement
                ...
                <li>
                  ...
                  party by greeting, directing and keeping them on task
                  throughout the day
                </li>
          ...
          <div className="row">
            <div className="col md12">
              <ul>
                ...
                <li>
                  Unlimited Facetime or Skype sessions with both lead planner
                  and designer
                </li>
                <li>
          ...
          <div className="row">
            <div className="col s12 md12 lg12">
              <p>
                ...
                Planning package includes everything the “Day Of” and “Partial
                Planning” packages do in addition to:
              </p>
            </div>
          </div>
        ...
        <div className="row">
          <div className="col m12 lg12">
            <p>
              <b>
                Are you more of a visual person? Don’t you worry. Check This
                Out.
              </b>
            </p>
            <a
